const DATA = [

  {
    ...
    alt: 'image of Dr. Bernard Okoe Boye',
    name: 'Dr. Bernard Okoe Boye',
  ...
  },
  {
    ...
    alt: 'image of Dr. Mathsidiso Moeti',
  ...
  },
  {
    ...
    alt: 'image of honourable Kwaku Agyeman Menu',
  ...
  },
  {
    ...
    alt: 'image of Keller Rinaudo Cliffton',
  ...
  },
  {
    ...
    alt: 'image of Zineb Drissi-Kaitouni',
...
function showSpeakerSection() {
  const featuredSpeakers = document.querySelector('.speakers');
  featuredSpeakers.innerHTML = `<h2 class="ft-speaker-txt">Featured Speakers</h2>
  <hr class="underline-speaker" />
  <div class="speaker-cards-box">
  </div><a class="more-btn"  href=""> MORE </a>
  <a class="less-btn hidden" href=""> LESS </a>`;
  ...
  for (let i = 0; i < DATA.length; i++) {
    speaker.innerHTML += `<div class="speaker-card">
      <div class="speaker-img-box">
        <img class="checkers" src="./images/checkers.png" alt="black checkers image" />
        <img class="checkers-desk" src="./images/checkersAsh.png" alt="ash checkers image" />
        <img class="speaker-img" src="${DATA[i].image}" alt="${DATA[i].alt}" />
      </div>
